    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm">
          <h3 className="text-sm font-semibold text-gray-900 mb-4">Uploads (Last 6 Months)</h3>
        ...
        {/* Content Type Pie */}
        <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm">
          <h3 className="text-sm font-semibold text-gray-900 mb-4">Content Breakdown</h3>
          ...
          {total === 0 && (
            <p className="text-xs text-gray-400 text-center mt-4">No resources yet. Upload your first CS resource!</p>
          )}
        </div>
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm">
          ...
          {topCategories.length > 0 ? (
            ...
            <p className="text-xs text-gray-400 text-center py-4">No categories with resources yet.</p>
          )}
        </div>

        {/* Recent Uploads */}
        <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm">
          <h3 className="text-sm font-semibold text-gray-900 mb-4">Recent Uploads</h3>
