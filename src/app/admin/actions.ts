...
export async function updateResource(id: string, updates: { title?: string; source_url?: string; worksheet_url?: string | null; content_type?: string; sort_order?: number | null }) {
  const supabase = createAdminClient();
