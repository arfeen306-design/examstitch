...
export const SUBJECT_TAXONOMY: Record<string, SubjectTaxonomy> = {
  ...
  'history': {
    ...
    aLevelSlug: 'history-9489',
    accentColor: '#A78BFA',
    displayCode: '2147/0470',
    gradient: 'from-indigo-500 to-violet-600',
    colorKey: 'indigo',
    iconKey: 'landmark',
    active: false, // flips to true after super-admin runs provisionPortalHierarchy('history')
    adminPortal: {
    ...
    aLevelPapers: {
      as: [
        { value: 'paper-1', label: 'Paper 1 — Document Question', description: 'Source-based analysis of historical documents' },
        { value: 'paper-2', label: 'Paper 2 — Outline Study', description: 'Essay-based study of a chosen period' },
      ],
      a2: [
        { value: 'paper-3', label: 'Paper 3 — Interpretations Question', description: 'Comparing competing historical interpretations' },
        { value: 'paper-4', label: 'Paper 4 — Depth Study', description: 'In-depth essay on a chosen depth-study topic' },
      ],
    },
  },
  ...
  'business': {
    ...
    aLevelPapers: {
      as: [
        { value: 'paper-1', label: 'Paper 1 — Short Answer & Essay', description: 'AS short answer and essay-based questions' },
        { value: 'paper-2', label: 'Paper 2 — Data Response', description: 'Data response and case study analysis' },
      ],
      a2: [
        { value: 'paper-3', label: 'Paper 3 — Case Study', description: 'In-depth case study analysis with calculations' },
      ],
    },
  },
};
